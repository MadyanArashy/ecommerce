...
<section class="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-12">
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <a href="/store" class="ms-1 text-sm font-medium text-gray-700 hover:text-primary-600 dark:text-gray-400 dark:hover:text-white md:ms-2">Products</a>
                </div>
              </li>
            </ol>
          </nav>
      ...
      <div class="mb-4 grid gap-4 sm:grid-cols-2 md:grid-cols-3 md:mb-8 lg:grid-cols-4">
         {{-- Product --}}
        @foreach($products as $product)
         <a href="{{ route('products.show', $product->id) }}">
        <div class="rounded-lg border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 transition-all hover:border-primary-600 ease-out border-4">
          <div class="h-56 w-56 mx-auto sm:mx-0 sm:w-full overflow-y-hidden">
              <img src="storage\{{ $product->image }}" class="object-cover w-full h-full">
            </div>
            <div class="pt-6">  
                <p class="text-lg font-semibold leading-tight text-gray-900 dark:text-white">{{ $product->title }}</p>  
                <div class="mt-4 flex flex-col items-left justify-between gap-4">
                    <p class="text-md line-clamp-2">{{ $product->desc }}</p>
